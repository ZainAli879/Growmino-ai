...
def build_image_prompt(
    ...
    prompt = (
        ...
        "Text rules are strict: render exactly one short headline and no other words. "
        "Do not render any instructions, labels, brand names, metadata, or extra captions. "
        "If perfect text rendering is uncertain, render no text at all. "
        f"EXACT_HEADLINE_TEXT=\"{image_headline}\". "
        "Render EXACT_HEADLINE_TEXT once, exactly as written, same spelling and capitalization. "
